    ...
    internal class PdfViewerViewModel : INotifyPropertyChanged
    {
        ...
        public IList<Document> PdfDocumentCollection
        {
            get
            {
                ...
                {
                    m_pdfDocumentCollection = new List<Document> { new Document("PDF_Succinctly"), new Document("GIS Succinctly"), new Document("HTTP Succinctly"), new Document("JavaScript Succinctly") };
                }
        ...
        public PdfViewerViewModel()
        {
            string filePath = string.Empty;
            filePath = "CustomToolbar.";
            m_pdfDocumentStream = typeof(App).GetTypeInfo().Assembly.GetManifestResourceStream(filePath+ "Assets.PDF_Succinctly.pdf");
